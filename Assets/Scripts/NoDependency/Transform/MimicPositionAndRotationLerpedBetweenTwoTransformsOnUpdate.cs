...
public class MimicPositionAndRotationLerpedBetweenTwoTransformsOnUpdate : Base
{
	...
	private Orientation Lerped
	{
		get
		{
			return Orientation.Lerp(OrientationA, OrientationB, Rate * (UseDeltaTime ? Time.deltaTime : 1));
		}
	}

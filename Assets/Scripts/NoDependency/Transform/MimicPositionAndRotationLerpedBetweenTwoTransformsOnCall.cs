...
public class MimicPositionAndRotationLerpedBetweenTwoTransformsOnCall : Base {
	...
	public string CallLerp;
	public string CallSetRateAndLerp;
	...
	private void Awake()
	{
		...
		CacheMethod(CallLerp, Lerp);
		CacheMethod(CallSetRateAndLerp, SetRateAndLerp);
	}

	private void SetRateAndLerp(object o)
	{
		SetRate(o);
		Lerp(o);
	}

	private void Lerp(object o)
	{
